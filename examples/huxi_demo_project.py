...
最近海岸在西北約 1.68 km → 地下水位由內陸(東南)向海(西北)遞降、流向西北。
"""
...
TPH_C, BZ_C, MT_C = (-25, 30), (-35, 42), (-50, 60)   # 羽流中心（略偏下游西北）
...
# 流向西北：海在西北(320°)，內陸(東南)水位高。SE 單位向量=(0.643,-0.766)
def head_of(e, n):
    return round(1.50 + 0.0042 * (0.643 * e - 0.766 * n), 3)
